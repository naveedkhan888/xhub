 ...
 */
class Xhub_Image_Box extends Widget_Base{
...
// After the Xhub_Image_Box class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Xhub_Image_Box() );