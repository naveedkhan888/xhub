 ...
 * Widget Name: Logo
 */
class Xhub_Logo extends Widget_Base{
...
// After the Xhub_Logo class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Xhub_Logo() );