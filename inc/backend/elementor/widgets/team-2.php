 ...
 * Widget Name: Team 2
 */
class Restobar_Team2 extends Widget_Base{
...
// After the Restobar_Team2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Restobar_Team2() );